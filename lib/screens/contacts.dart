...
import 'package:manga_base/data/contact_group.dart';
import 'package:manga_base/data/contact.dart';
            ...
            slivers: [
              ...
              SliverList.list(
                children: [
                  ...
                  ...contacts.keys.map(
                    (String initial) => ContactListSection(lastInitial: initial, contacts: contacts[initial]!),
                  )
                ],
              ),
            ],
